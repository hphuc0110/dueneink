        ...
        <section className="py-12 sm:py-16 md:py-20 border-t border-black/10">
          <div className="container mx-auto px-4 sm:px-6 max-w-6xl">
            ...
            <p className="text-center text-sm sm:text-base text-black/80 mt-10 sm:mt-12">
              See more at{" "}
              <Link href="/product" target="_blank" rel="noopener noreferrer" className="underline hover:no-underline">
                product
              </Link>{" "}
              or  {" "}
              <Link href="https://www.instagram.com/duene.inkstudio?igsh=eWlyMTJvNDMydGJ1" target="_blank" rel="noopener noreferrer" className="underline hover:no-underline">
                @duene.inkstudio
              </Link>{" "}
            </p>
          </div>
